<template>
  ...
  <svg id="Capa_1" style="cursor: pointer; min-height: 30px; max-height: 30px; min-width: 30px; max-width: 30px; fill: rgba(0, 0, 0, 0.54);" enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
